...
audio,fs = sf.read('D:\\jupyter_python\\AI_ML_repository_2\\Week 4\\white_noise.wav')
...
denoise_path = "D:\\jupyter_python\\AI_ML_repository_2\\Week 4\\out.wav"
# write to .wav file 
sf.write(denoise_path, out_file, fs)
